...
public class AdaptadorSede extends BaseAdapter {
    private ArrayList<Sede> lista;
    private Activity context;
    private EditText editText;
    private ImageButton btnGuardar;

    public AdaptadorSede(ArrayList<Sede> lista, Activity context, EditText et, ImageButton btnGuardar) {
        this.lista = lista;
    ...
    public View getView(final int posicion, View convertView, ViewGroup parent) {
        ...
        nombre.setText("" + lista.get(posicion).getDireccion());
        ...
        swEstado.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                sede.setCodigo(lista.get(posicion).getCodigo());
                sede.setDireccion(lista.get(posicion).getDireccion());

                final ProgressDialog dialog = Functions.CargarDatos("Actualizando estado", context);
                dialog.show();
                dialog.setCancelable(false);
                BddSede.updateSede(sede, context, new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        dialog.dismiss();
                        lista.get(posicion).setEstado(sede.getEstado());
                        AdaptadorSede.super.notifyDataSetChanged();
                    }
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                editText.setText(lista.get(posicion).getDireccion());
